...
export default function SketchFAQ() {
    ...
    <section className="min-h-screen py-24 px-4 bg-amber-50" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'100\' height=\'100\' viewBox=\'0 0 100 100\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M11 18c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm48 25c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm-43-7c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm63 31c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM34 90c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm56-76c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM12 86c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm28-65c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm23-11c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-6 60c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm29 22c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zM32 63c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm57-13c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-9-21c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM60 91c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM35 41c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM12 60c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2z\' fill=\'%23d4a574\' fill-opacity=\'0.1\' fill-rule=\'evenodd\'/%3E%3C/svg%3E")' }}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <span className="text-gray-800 font-semibold pr-4" style={{ fontFamily: '"Comic Sans MS", cursive, sans-serif' }}>
                  {faq.q}
                </span>
                <span
                  className={`flex-shrink-0 w-10 h-10 rounded-full border-2 border-gray-700 flex items-center justify-center font-bold text-xl transition-transform duration-300 ${
                    openIndex === i ? 'rotate-45 bg-gray-700 text-white' : 'bg-amber-200 text-gray-700'
                  }`}
              ...
              >
                <div className="px-6 pb-5 border-t-2 border-dashed border-gray-300 pt-4">
                  <p className="text-gray-600 leading-relaxed" style={{ fontFamily: '"Comic Sans MS", cursive, sans-serif' }}>
                    {faq.a}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          <svg className="w-24 h-24 mx-auto text-amber-400 opacity-50" fill="currentColor" viewBox="0 0 100 100">
