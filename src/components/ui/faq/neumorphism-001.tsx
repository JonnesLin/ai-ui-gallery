...
export default function NeumorphismFAQ() {
  return (
    <section className="min-h-screen py-24 px-4 bg-gray-200">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-700 mb-4">Frequently Asked Questions</h2>
          <p className="text-gray-500">Got questions? We have answers</p>
        </div>

        <FAQ theme="neumorphism" variant="cards" items={faqItems} allowMultiple={false} />
      </div>
    </section>
  );
}
