...
export default function NeumorphismTestimonial() {
  ...
  return (
    <section className="py-24 px-6 bg-gray-200 min-h-screen flex items-center">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {testimonials.map((testimonial, i) => (
            <Testimonial
              ...
              className="hover:shadow-[inset_4px_4px_8px_#b8b8b8,inset_-4px_-4px_8px_#ffffff] transition-all duration-300"
            />
          ))}
        </div>
      </div>
