    ...
    <section className="min-h-screen bg-gray-50 px-4 py-24">
      <div className="mx-auto max-w-7xl">
        <div className="mb-20 border-l-4 border-blue-600 pl-8">
          <h2 className="mb-4 text-5xl font-bold text-gray-900">Executive Leadership</h2>
          <p className="text-xl text-gray-600">Guiding our organization to excellence</p>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          {team.map((member, index) => (
            ...
            >
              <div className="aspect-square w-full bg-gradient-to-br from-blue-100 to-blue-50"></div>

              <div className="p-6">
                <h3 className="mb-2 text-xl font-bold text-gray-900">{member.name}</h3>
                <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-blue-600">{member.role}</p>
