...
export default function CyberpunkChatWidget() {
  ...
  return (
    <div className="flex flex-col gap-8 p-8 bg-black min-h-screen">
      <h2 className="text-sm font-bold text-cyan-400 uppercase tracking-widest">Cyberpunk Chat Widget</h2>
      ...
      <div className="max-w-sm">
        <ChatWidget
          ...
          onSend={handleSend}
          placeholder="jack.in..."
          quickReplies={['Access Grid', 'Decrypt Data', 'Exit Matrix']}
        />
      </div>
    </div>
  );
