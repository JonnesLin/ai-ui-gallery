...
export default function LuxuryChatWidget() {
  ...
  return (
    <div className="flex flex-col gap-8 p-8 bg-stone-900 min-h-screen">
      <h2 className="text-sm font-light text-amber-400 uppercase tracking-[0.3em]">Luxury Chat Widget</h2>
      ...
      <div className="max-w-sm">
        <ChatWidget
          ...
          quickReplies={['Reservations', 'Exclusive Offers', 'VIP Services']}
        />
      </div>
    </div>
  );
