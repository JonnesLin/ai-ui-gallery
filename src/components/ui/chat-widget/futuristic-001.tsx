...
export default function FuturisticChatWidget() {
  ...
  return (
    <div className="flex flex-col gap-8 p-8 bg-slate-950 min-h-screen">
      <h2 className="text-sm font-light text-cyan-300 uppercase tracking-[0.2em]">Futuristic Chat Widget</h2>
      ...
      <div className="max-w-sm">
        <ChatWidget
          ...
          quickReplies={['System Status', 'Quantum Query', 'Neural Sync']}
        />
      </div>
    </div>
  );
