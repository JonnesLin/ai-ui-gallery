export default function GlassmorphismErrorPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 flex items-center justify-center px-4">
      ...
      <div className="relative backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-12 text-center max-w-md shadow-2xl">
        ...
        <button className="px-8 py-3 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition-all border border-white/30">
          Navigate Home
        </button>
      </div>
    </div>
