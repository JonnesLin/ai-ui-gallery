...
export default function FlatTableRefactored() {
  const data = [
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-8 bg-gray-100">
      ...
      <div className="bg-white overflow-hidden">
        <Table theme="flat" variant="striped" size="md">
          <TableHeader>
            <TableRow>
              <TableCell header>
                <input
          ...
          <TableBody>
            {data.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell>
                  <span className="px-3 py-1 bg-purple-500 text-white text-sm font-medium">{row.role}</span>
                </TableCell>
                <TableCell>
                  <span
      ...
      <div className="mt-6 flex items-center justify-between bg-white p-4">
        ...
        <div className="flex gap-2">
          <button
            className="px-4 py-2 bg-gray-300 text-gray-500 font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            disabled
          >
            Previous
          </button>
          <button className="px-4 py-2 bg-blue-500 text-white font-bold">1</button>
