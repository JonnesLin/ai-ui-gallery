...
export default function MaterialDashboardRefactored() {
          ...
          <div className="space-y-4">
            {activities.map((activity, index) => {
              ...
              return (
                ...
                >
                  <div className={cn('w-10 h-10', colors[index], 'rounded-full flex items-center justify-center text-white text-sm font-medium shadow-lg')}>
                    {activity.avatar}
                  </div>
