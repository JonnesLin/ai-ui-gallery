...
export default function GlassmorphismProfilePageNew() {
  return (
    <ProfilePage
      theme="glassmorphism"
      layout="full"
      header={{
        avatar: 'bg-white/20 backdrop-blur-sm border border-white/30',
        name: 'Sarah Williams',
      ...
      info={{
        ...
        items: [
          ...
          },
          {
            ...
            text: 'sarah.williams@email.com',
            link: 'mailto:sarah.williams@email.com',
          },
        ],
      }}
    >
