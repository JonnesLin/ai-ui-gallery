...
export default function DarkProfilePageNew() {
  return (
    <ProfilePage
      theme="dark"
      layout="full"
      header={{
        coverImage: 'bg-gradient-to-r from-gray-800 to-gray-900',
        avatar: 'bg-gray-800 border-4 border-gray-950 shadow-2xl',
        name: 'David Martinez',
        username: 'davidmartinez',
        bio: 'Full-stack developer passionate about building scalable applications. Coffee enthusiast and open source contributor.',
        actions: (
          <>
      ...
      info={{
        items: [
          ...
          },
          {
            ...
            text: 'davidmartinez.dev',
            link: 'https://davidmartinez.dev',
          },
          {
            icon: (
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
